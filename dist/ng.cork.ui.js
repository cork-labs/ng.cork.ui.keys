/**
 * ng.cork.ui.keys - v0.0.4 - 2015-04-08
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.keys.enter-click', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.keys.enter-click.corkUiEnterClick
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.keys.focus-on', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.keys.focus-on.corkUiFocusOn
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.keys.stop-propagation', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.keys.stop-propagation.corkUiStopPropagation
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.keys.textarea-auto-resize', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.keys.textarea-auto-resize.corkUiTextareaAutoResize
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.keys', [
        'ng.cork.ui.keys.enter-click',
        'ng.cork.ui.keys.focus-on',
        'ng.cork.ui.keys.stop-propagation'
    ]);
